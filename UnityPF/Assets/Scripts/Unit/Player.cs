...
namespace UnityEngine {
	...
	public partial class GameFramework {
		public class CPlayer : CUnit {
			...
			public void					SetLoginId(CHAR[] o)		{ Array.Clear(m_szLoginId, 0, m_szLoginId.Length); INT iLength = o.Length; if(iLOGIN_ID_LEN < iLength) { iLength = iLOGIN_ID_LEN; } Array.Copy(o, 0, m_szLoginId, 0, iLength); m_szLoginId[iLOGIN_ID_LEN] = (CHAR)('\0'); }
