...
namespace UnityEngine {
	...
	public partial class GameFramework {
		public class CStateChannel : CState {
			public CStateChannel() {}
			~CStateChannel() {}

			public override bool
			Initialize() {
				if(false == m_bInitialized) {
					//TRACE("CStateChannel: Initialize()");
					m_eStateType = STATE_TYPE.STATE_CHANNEL;
			...
			PreProcess(STATE_TYPE o) {
				TRACE("preprocess: STATE_CHANNEL: " + o + " -> " + GetStateType());

				//TRACE("preprocess: STATE_CHANNEL: begin");
				...
				//TRACE("preprocess: STATE_CHANNEL: end");
				return true;
			}

			public override bool
			PostProcess(STATE_TYPE o) {
				TRACE("postprocess: STATE_CHANNEL: " + GetStateType() + " -> " + o);

				//TRACE("postprocess: STATE_CHANNEL: begin");

				//TRACE("postprocess: STATE_CHANNEL: end");
				return true;
			}
