...
namespace UnityEngine {
	...
	public class ExampleAutoConnect : GameFramework {
		public void
		Awake() {
#if UNITY_STANDALONE
		...
		Start() {
			...
			m_kAutoToggle.isOn = AutoConnected;
			...
			g_kCfgMgr.SetAutoConnect(AutoConnected);
			if(EnableMainPort) {
		...
		public void
		OnAuto() {
			g_kCfgMgr.SetAutoConnect(m_kAutoToggle.isOn);

			//MESSAGE("auto reconnection: " + g_kCfgMgr.IsAutoConnected());
		}
		...
		public Button		m_kDisconnectButton;
