...
namespace UnityEngine {
	...
	public partial class GameFramework {
		public class CStateLobby : CState {
			public CStateLobby() {}
			~CStateLobby() {}
			...
			Initialize() {
				if(false == m_bInitialized) {
					//TRACE("CStateLobby: Initialize()");
					m_eStateType = STATE_TYPE.STATE_LOBBY;
			...
			PreProcess(STATE_TYPE o) {
				TRACE("preprocess: STATE_LOBBY: " + o + " -> " + GetStateType());

				//TRACE("preprocess: STATE_LOBBY: begin");
				...
				//TRACE("preprocess: STATE_LOBBY: end");
				return true;
			}

			public override bool
			PostProcess(STATE_TYPE o) {
				TRACE("postprocess: STATE_LOBBY: " + GetStateType() + " -> " + o);

				//TRACE("postprocess: STATE_LOBBY: begin");

				//TRACE("postprocess: STATE_LOBBY: end");
				return true;
			}
